...
public abstract class Graph<L> {
    ...
    /**
     * Cancella tutti i nodi e gli archi di questo grafo portandolo a essere un
     * grafo vuoto.
     */
    ...
    /**
     * Aggiunge un arco a questo grafo tra due nodi di un indice dato. Se il grafo
     ...
     *              orientato, altrimenti l'indice di uno dei nodi del nuovo
     *              arco
     * @param j
     *              l'indice del nodo destinazione del nuovo arco in caso di
     *              grafo orientato, altrimenti l'indice di uno dei nodi del
     *              nuovo arco
     * @return true se l'arco è stato inserito, false se un arco esattamente
     *         uguale già esiste
     * @throws IndexOutOfBoundsException
    ...
    /**
     * Aggiunge un arco pesato a questo grafo tra due nodi di un indice dato. Se il
     ...
     *                   grafo orientato, altrimenti l'indice di uno dei nodi
     *                   del nuovo arco
     * @param j
     *                   l'indice del nodo destinazione del nuovo arco in caso
     *                   di grafo orientato, altrimenti l'indice di uno dei nodi
     *                   del nuovo arco
     * @param weight
     *                   il peso da associare all'arco
     * @return true se l'arco è stato inserito, false se un arco esattamente
     ...
     *         sorgente nel nodo di un indice i e destinazione nel nodo di un indice
     *         j. Se il grafo non è orientato allora l'arco restituito può
     *         contenere il nodo di un indice i e il nodo di un indice j in qualsiasi
     *         ordine
     * @throws IndexOutOfBoundsException
     *                                           se almeno uno degli indici
     *                                           passati non corrisponde a
